...
const faqs = [
  ...
  ["How does this relate to FPX?","FPX Sourcing is the digital sourcing platform supported by Sutcliffe Trading. You can work directly with our traders or explore available timber through FPX."],
];
...
export default function Home() { return <main>
  ...
  <section className="fpx-editorial shell section-pad reveal"><div className="fpx-copy"><p className="eyebrow">Digital sourcing</p><h2 className="display-serif">Traditional timber knowledge.<br/><em>Now easier to access.</em></h2><p>FPX Sourcing is supported by Sutcliffe Trading&apos;s real product knowledge, established supply relationships and accountability when it matters.</p><a className="button button-dark" href="https://www.fpx.nz/" target="_blank" rel="noreferrer">Explore FPX Sourcing ↗</a></div><div className="fpx-emblem"><img src="/fpx-sourcing-logo.png" alt="FPX Sourcing"/><span>Search current stock · Post a requirement · Work with experienced traders</span></div></section>
